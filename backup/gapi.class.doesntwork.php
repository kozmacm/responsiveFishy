 ...
 * 
 * EXPERIMENTAL UPDATE USING API V2 AND IMPLEMENTING SEGMENT SUPPORT
 *
 *
...
class gapi
{
  ...
  //dynamic::ga:pagePath!@OVKEY;ga:pagePath!@OVMTC;ga:pagePath!@OVKWID;ga:referralPath!@OVRAW;ga:pagePath!@OVADID
  ...
  */
  ...
  private function curlRequest($url, $get_variables=null, $post_variables=null, $headers=null)
  {
    ...
    //$get_variables = str_ireplace('%21','!',$get_variables);
    
    //echo '<p>' . $url . ($get_variables) . '</p>';
